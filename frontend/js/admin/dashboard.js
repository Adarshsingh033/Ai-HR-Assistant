...
function renderRecentOrganizations(orgs) {
    ...
    container.innerHTML = orgs.map(o => {
        ...
        const statusBadge = isInactive
            ? `<span style="padding: 2px 8px; border-radius: 99px; background: rgba(239, 68, 68, 0.12); color: var(--danger); font-size: 0.72rem; font-weight: 700;">Inactive</span>`
        ...
        return `
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 12px 14px; background: var(--bg-subtle); border: 1px solid var(--border); border-radius: 12px; margin-bottom: 10px;">
